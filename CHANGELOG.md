...
## [2.0.4-beta] - 2026-09-10

### Fixed

- Unexpected argument 'dtype' [LVD-348]
- Fix makefile
...
- Change shared workflow location & update makefile

### Fixed

- Missing packages for excel support [LVD-339]
- Input_cols split with spaces  mismatch [LVD-344]
