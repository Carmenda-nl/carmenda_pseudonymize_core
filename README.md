...
Follow the extended instructions on the [wiki](https://github.com/Carmenda-nl/carmenda-deduce-engine/wiki), or refer to
...
```bash
git clone --recursive https://github.com/Carmenda-nl/carmenda-deduce-engine.git
```

Open a terminal and navigate to the `app` folder of this project:

```bash
cd carmenda-deduce-engine/app
```
